...
- local web page for weather informations and configuration
 f4goh@orange.fr
- some little changes from philip@schroth.cx (PA3DFN)
*/
...
void loop()
{
  ...
  ESP.deepSleep(10 * 60000000, WAKE_RF_DEFAULT); // Sleep for 60 seconds
  delay(1000);
}
...
//  sprintf(sentence, "%s>APRS,TCPXX*:@%02d%02d%02dz%s/%s_.../...g...t%03dr...p...P...h%02db%05d", station.callsign, station.latitude, station.longitude, wx.temperatureF / 10, wx.humidite, wx.pression / 10);
...
void initBme()
{
  ...
  //specify I2C address.  Can be 0x77(default) or 0x76 kleine = 0x76, grote = 0x77
